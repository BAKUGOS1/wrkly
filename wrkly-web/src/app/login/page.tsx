    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-4 py-12">
      ...
      <div className="w-full max-w-[420px] rounded-[16px] border border-border bg-card p-6 sm:p-10 shadow-sm">
        <div className="text-center">
          <h1 className="text-[24px] font-semibold tracking-tight text-foreground">Welcome back</h1>
          <p className="mt-[8px] text-[14px] text-muted-foreground">Sign in to your workflow</p>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-[16px]">
          <div className="space-y-[6px]">
            ...
            <Input id="email" type="email" placeholder="you@example.com" autoComplete="email" disabled={isAnyLoading} className="h-[44px]" {...register("email")} />
          ...
          <div className="space-y-[6px]">
            ...
            <div className="relative">
              <Input id="password" type={showPassword ? "text" : "password"} autoComplete="current-password" disabled={isAnyLoading} className="h-[44px] pr-10" {...register("password")} />
