          ...
          <div className="relative z-10 w-full max-w-lg">
            <div className="mb-12">
              ...
              <h1 className="font-headline text-display-lg text-6xl font-extrabold tracking-tight text-surface-container-lowest leading-[1.1] mb-6">
                Curate your <br />
                <span className="text-primary-container">productivity.</span>
              </h1>
              <p className="text-xl text-outline-variant font-medium max-w-md leading-relaxed">
                Experience a workspace that breathes with you. Precision
                engineering meets editorial elegance.
              </p>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div className="p-6 rounded-2xl bg-surface-container-lowest/5 backdrop-blur-md border border-surface-container-lowest/10">
                ...
                <h3 className="text-surface-container-lowest font-semibold mb-1">
                  Focus Flow
                </h3>
                <p className="text-outline-variant text-sm">
                  Adaptive interfaces for deep work sessions.
                </p>
              </div>
              <div className="p-6 rounded-2xl bg-surface-container-lowest/5 backdrop-blur-md border border-surface-container-lowest/10">
                <span
                ...
                <p className="text-outline-variant text-sm">
                  Organize projects with multi-dimensional depth.
                </p>
              </div>
            </div>
          </div>
        ...
        <section className="w-full lg:w-1/2 flex flex-col justify-center items-center p-6 md:p-12 lg:p-24 bg-surface">
          <div className="w-full max-w-md">
            ...
            <form className="space-y-6">
              <div>
                <label
                  className="block text-[11px] uppercase tracking-[0.05em] font-bold text-on-surface-variant mb-2 ml-1"
                  htmlFor="email"
                >
                  Email Address
                </label>
                <input
                  className="w-full px-4 py-3.5 rounded-xl bg-surface-container-high border-none focus:ring-2 focus:ring-primary/20 focus:bg-surface-container-lowest text-on-surface transition-all placeholder:text-outline"
                  id="email"
                  name="email"
              ...
              <div>
                <div className="flex justify-between items-center mb-2 ml-1">
                  <label
                    className="block text-[11px] uppercase tracking-[0.05em] font-bold text-on-surface-variant"
                    htmlFor="password"
                  >
                    Password
                  </label>
                  <a
                    className="text-[11px] uppercase tracking-[0.05em] font-bold text-primary hover:text-primary-dim transition-colors"
                    href="#"
                  >
                    Forgot Password?
                  </a>
              ...
              <div className="flex items-center space-x-3 ml-1">
                <input
                  className="w-5 h-5 rounded border-outline-variant bg-surface-container-high text-primary focus:ring-primary/20 transition-all"
                  id="remember"
                  name="remember"
                  type="checkbox"
                />
              ...
              <button
                className="w-full py-4 rounded-xl bg-primary-gradient text-on-primary font-bold text-base shadow-xl shadow-primary/20 hover:scale-[1.02] active:scale-95 transition-all duration-200"
                type="submit"
              >
                Sign In
              </button>
            ...
            <button
              className="w-full py-4 flex items-center justify-center gap-3 rounded-xl bg-surface-container-highest text-primary font-bold text-base hover:bg-surface-container-high transition-colors active:scale-95 duration-200"
              type="button"
            >
